...
# schema_view = get_swagger_view(title='HallMed API')
...
schema_view = get_schema_view(
    openapi.Info(
        title="HallMed API",
        default_version='v1',
        description="API del proyecto HallMed",
        terms_of_service="https://www.hallmed.ec",
        contact=openapi.Contact(email="goarorue@gmail.com"),
